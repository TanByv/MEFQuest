...
.data
    ...
    floor1_ilkay_dialog2: .asciiz "Student 1: Sorry but instead of attending class most people are learning calculus by watching 'Buders Bogaziciliden'. They really don't need your classes.\n\n"
